...
$3$ & $\begin{tabular}{l}
$\left\{ x_{0} x_{1} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, n_{1}\right),\left(1, n_{1}\right),\left(n_{1}, -1\right),\left(n_{1}, 1\right),\left(-1, -1\right),\left(-1, 1\right),\left(1, -1\right),\left(1, 1\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$4$ & $\begin{tabular}{l}
$\left\{ x_{0} x_{1} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, n_{1}\right),\left(1, n_{1}\right),\left(n_{1}, -1\right),\left(n_{1}, 1\right),\left(-1, -1\right),\left(-1, 1\right),\left(1, -1\right),\left(1, 1\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$5$ & $\begin{tabular}{l}
$\left\{ {\left(x_{0} - 2 \, x_{1}\right)} x_{0} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, n_{1}\right),\left(-1, -1\right),\left(-1, 0\right),\left(1, n_{1}\right),\left(1, 1\right),\left(2 \, t_{0} - 1, t_{0}\right),\left(2 \, t_{0} + 1, t_{0}\right),\left(1, 0\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$6$ & $\begin{tabular}{l}
$\left\{ -x_{0} x_{1} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, -1\right),\left(-1, 1\right),\left(1, -1\right),\left(1, 1\right)\right\}\right\}$ \\
$\left\{ x_{0} x_{1} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, n_{1}\right),\left(1, n_{1}\right),\left(n_{1}, -1\right),\left(n_{1}, 1\right),\left(-1, -1\right),\left(-1, 1\right),\left(1, -1\right),\left(1, 1\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$7$ & $\begin{tabular}{l}
$\left\{ x_{0} x_{1} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, n_{1}\right),\left(1, n_{1}\right),\left(n_{1}, -1\right),\left(n_{1}, 1\right),\left(-1, -1\right),\left(-1, 1\right),\left(1, -1\right),\left(1, 1\right)\right\}\right\}$ \\
...
$9$ & $\begin{tabular}{l}
$\left\{ {\left(x_{0} - 2 \, x_{1}\right)} x_{0} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, n_{1}\right),\left(-1, -1\right),\left(-1, 0\right),\left(1, n_{1}\right),\left(1, 1\right),\left(2 \, t_{0} - 1, t_{0}\right),\left(2 \, t_{0} + 1, t_{0}\right),\left(1, 0\right)\right\}\right\}$ \\
$\left\{ -x_{0}^{2} + 2 \, x_{0} x_{1} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, -1\right),\left(-1, 0\right),\left(1, 0\right),\left(1, 1\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$10$ & $\begin{tabular}{l}
$\left\{ x_{0}^{2} + x_{1}^{2} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, 0\right),\left(0, -1\right),\left(0, 1\right),\left(1, 0\right)\right\}\right\}$ \\
$\left\{ -x_{0}^{2} - x_{1}^{2} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, 0\right),\left(0, -1\right),\left(0, 1\right),\left(1, 0\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$11$ & $\begin{tabular}{l}
...
\end{tabular}$ \\ \hline
$13$ & $\begin{tabular}{l}
$\left\{ x_{0}^{2} + {\left(x_{0} + x_{1}\right)} x_{1} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, 0\right),\left(-1, 1\right),\left(0, -1\right),\left(0, 1\right),\left(1, -1\right),\left(1, 0\right)\right\}\right\}$ \\
$\left\{ -{\left(x_{0} + x_{1}\right)} x_{0} - x_{1}^{2} \, | \, (x_{0},x_{1})\in\mathbb{Z}^2 \, / \,\left\{\left(-1, 0\right),\left(-1, 1\right),\left(0, -1\right),\left(0, 1\right),\left(1, -1\right),\left(1, 0\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$14$ & $\begin{tabular}{l}
$\left\{ -x_{0}^{2} \, | \, x_{0}\in\mathbb{Z} \, / \,\left\{-1,1\right\}\right\}$ \\
$\left\{ x_{0}^{2} \, | \, x_{0}\in\mathbb{Z} \, / \,\left\{-1,1\right\}\right\}$ \\
