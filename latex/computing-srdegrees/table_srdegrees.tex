...
$3$ & $\begin{tabular}{l}
$\left\{ x_{0} x_{1} \, | \, (x_{0},x_{1})\in \mathbb{Z} \times \mathbb{Z} \, / \,\left\{\left(n_{1}, -1\right),\left(1, n_{1}\right),\left(n_{1}, 1\right),\left(-1, -1\right),\left(-1, 1\right),\left(-1, n_{1}\right),\left(1, -1\right),\left(1, 1\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$4$ & $\begin{tabular}{l}
$\left\{ x_{0} x_{1} \, | \, (x_{0},x_{1})\in \mathbb{Z} \times OZ \, / \,\left\{\left(n_{1}, -1\right),\left(1, n_{1}\right),\left(n_{1}, 1\right),\left(-1, -1\right),\left(-1, 1\right),\left(-1, n_{1}\right),\left(1, -1\right),\left(1, 1\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$5$ & $\begin{tabular}{l}
$\left\{ {\left(x_{0} - 2 \, x_{1}\right)} x_{0} \, | \, (x_{0},x_{1})\in \mathbb{Z} \times \mathbb{Z} \, / \,\left\{\left(-1, -1\right),\left(-1, 0\right),\left(-1, n_{1}\right),\left(1, n_{1}\right),\left(1, 0\right),\left(1, 1\right),\left(2 \, t_{0} - 1, t_{0}\right),\left(2 \, t_{0} + 1, t_{0}\right)\right\}\right\}$ \\
\end{tabular}$ \\ \hline
$6$ & $\begin{tabular}{l}
$\left\{ x_{0} x_{1} \, | \, (x_{0},x_{1})\in \mathbb{Z} \times \mathbb{Z} \, / \,\left\{\left(n_{1}, -1\right),\left(1, n_{1}\right),\left(n_{1}, 1\right),\left(-1, -1\right),\left(-1, 1\right),\left(-1, n_{1}\right),\left(1, -1\right),\left(1, 1\right)\right\}\right\}$ \\
...
\end{tabular}$ \\ \hline
$8$ & $\begin{tabular}{l}
$\left\{ x_{0} x_{1} \, | \, (x_{0},x_{1})\in OZ \times OZ \, / \,\left\{\left(n_{1}, -1\right),\left(1, n_{1}\right),\left(n_{1}, 1\right),\left(-1, -1\right),\left(-1, 1\right),\left(-1, n_{1}\right),\left(1, -1\right),\left(1, 1\right)\right\}\right\}$ \\
