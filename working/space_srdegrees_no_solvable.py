...
from src.cryst3.gen_norms3 import all_unique_lattice_matrices, find_groups


prepare_gap_env()

count = 0
for A in all_unique_lattice_matrices:
    # print(A)
    # print()
    try:
        solve_simple_mat(A)
        ...
        print(f'group num: {find_groups(A, latt=True)}')
        count += 1
        print()
        print()
