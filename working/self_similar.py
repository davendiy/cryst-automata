...
def linear_part(el): 
    n = el.dimensions()[_sage_const_0 ]
    return el[:n-_sage_const_1 , :n-_sage_const_1 ]


def translation(el): 
    n = el.dimensions()[_sage_const_0 ]
    return el[:n-_sage_const_1 , -_sage_const_1 ]


def construct_element(linear, trans): 
    n = linear.dimensions()[_sage_const_0 ] + _sage_const_1 
    res = matrix.identity(QQ, n)
    res[:n-_sage_const_1 , :n-_sage_const_1 ] = linear 
    res[:n-_sage_const_1 , -_sage_const_1 ] = trans
    return res 
...
def from_translation(trans): 
    n = trans.numpy().flatten().shape[_sage_const_0 ] + _sage_const_1 
    res = matrix.identity(QQ, n)
    res[:n-_sage_const_1 , -_sage_const_1 ] = trans 
    return res
...
def build_group(group_index, dim=_sage_const_2 , deep=_sage_const_3 ):
